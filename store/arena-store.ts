/**
 * store/arena-store.ts — Arena Mode state management
 *
 * Send the same prompt to 2 AIs anonymously, let the user pick the winner.
 */
...
const STORAGE_KEY = 'chelly_arena_history';
